...
X 的定位是引流：作者发视频后配一条推文——一句真实心得 + 这条视频讲了什么/解决什么问题 + 引导去看视频；不是把正文复制过去。
...
只输出以下 JSON（不要 markdown 代码块）：
{
  ...
  "shipinhao": {"title": "微信视频号标题(≤22字，比抖音更平实、面向熟人社交场景)"},
  "x": {"post_zh": "中文引流推文，≤140字", "post_en": "English tweet, ≤280 chars, 1-2 hashtags"}
}`;
}
